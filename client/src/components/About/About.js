    ...
    <div>
      <div className="col s12 m7">
        <div className="card">
          <div className="card-content container">
            <h5 className="blue-text center" style={{ padding: '1rem', margin: '1rem' }}>Как стать КнигоЗакладчиком?</h5>
            <div className="">
              <h5 className="left-align orange-text">
                Поделись книгой
          </h5>
              <h6>
                Введи необходимую информацию о книге и месте ее заложения, выбери точку на карте и впиши уникальный номер в книгу.
                И не забудь написать что книга участвует в Буккроссинге с помощью проекта КнигоЗакладчик.
          </h6>
              <h5 className="left-align orange-text">
                Возьми книгy
          </h5>
              <h6>
                Выбери книгу на карте, найди ее и бесплатно стань ее новым временным владельцем, указав ее уникальный номер.
          </h6>
              <h5 className="left-align orange-text">
              Передай книгу дальше
          </h5>
              <h6>
              Позволь книге путешествовать дальше выбрав для нее новый временный адрес. 
          </h6>
          <h5 className="left-align orange-text">
                Следи за книгой и общайся
          </h5>
              <h6>
                На твоей странице ты найдешь список книг. Перейдя на одну из них ты сможешь отследить ее перемещения и пообщаться с теми кому она попадалась в руки.
          </h6>
            </div>
          </div>
        </div>
      ...
      (с) The New York Times
        ...
        <div className="card center">
          ...
          <div className="card-content container">
            <h5 className="orange-text" style={{ padding: '1rem', margin: '1rem' }}>Цель Буккроссинга</h5>
            <div className="">
